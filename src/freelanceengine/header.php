        ...
        <div class="fre-header-wrap">
            <div class="container">
                ...
                <div class="fre-search-wrap">
                    <form class="fre-form-search" action="<?php echo get_post_type_archive_link( PROFILE ); ?>" method="post">
                        <div class="fre-search dropdown">
                            <span class="fre-search-dropdown-btn dropdown-toggle" data-toggle="dropdown">
                                <i class="fa fa-search" aria-hidden="true"></i>
                                <i class="fa fa-caret-down" aria-hidden="true"></i>
                            </span>
                            <input class="fre-search-field" name="keyword" value="<?php echo isset($_POST['keyword']) ? $_POST['keyword'] : "" ?>" type="text" placeholder="<?php _e('Find Freelancers', ET_DOMAIN);?>">
                            <ul class="dropdown-menu fre-search-dropdown">
                                <li><a class="active" data-type="profile" data-action="<?php echo get_post_type_archive_link( PROFILE ); ?>"><?php _e('Find Freelancers', ET_DOMAIN);?></a></li>
                                <li><a class="" data-type="project" data-action="<?php echo get_post_type_archive_link( PROJECT ); ?>"><?php _e('Find Projects', ET_DOMAIN);?></a></li>
                            </ul>
                        </div>
                    </form>
                </div>
                    ...
                    <ul class="fre-menu-main">
                        ...
                        <?php if(!is_user_logged_in()){ ?>
                            <li class="fre-menu-freelancer dropdown" >
                                <a><?php _e('FREELANCERS', ET_DOMAIN);?><i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                <ul class="dropdown-menu">
                                    <li>
                ...
                <?php if(!is_user_logged_in() ){ ?>
                    <div class="fre-account-wrap">
                        <div class="fre-login-wrap">
                            <ul class="fre-login">
                                <li><a href="<?php echo et_get_page_link("login") ?>"><?php _e('LOGIN', ET_DOMAIN);?></a></li>
                                <?php if(fre_check_register()){ ?>
                                <li><a href="<?php echo et_get_page_link("register") ?>"><?php _e('SIGN UP', ET_DOMAIN);?></a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>

<div class="fre-project-filter-box">
        ...
        <div class="fre-project-list-filter">
            <form>
                <div class="row">
                    <div class="col-md-4">
                        <div class="fre-input-field">
                            ...
                            <input class="keyword search" id="s" type="text" name="s" placeholder="<?php _e('Search projects by keywork', ET_DOMAIN);?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="fre-input-field dropdown">
                            <label for="skills" class="fre-field-title"><?php _e('Skill', ET_DOMAIN);?></label>
                            <input id="skills" class="dropdown-toggle fre-skill-field" readonly type="text" placeholder="Search project by skill" data-toggle="dropdown">
                    ...
                    <div class="col-md-4">
                        <div class="fre-input-field">
                            <label for="project_category" class="fre-field-title"><?php _e('Select categories', ET_DOMAIN);?></label>
                            <?php ae_tax_dropdown( 'project_category' , array(  
                                        ...
                                        'show_option_all' => __("Choose category", ET_DOMAIN),
                    ...
                    <div class="col-md-4">
                        <div class="fre-input-field project-number-bids">
                            <label for="number_bids" class="fre-field-title"><?php _e('Number of Bids', ET_DOMAIN);?></label>
                ...
                <a class="project-filter-clear clear-filter" href=""><?php _e('Clear all filter', ET_DOMAIN);?></a>
            </form>
        </div>
    </div>
<div class="fre-profile-filter-box">
      ...
      <div class="fre-profile-list-filter">
          <form>
              <div class="row">
                  <div class="col-md-4">
                      <div class="fre-input-field">
                          ...
                          <input class="keyword search" id="s" type="text" name="s" placeholder="<?php _e('Seach freelancers by keywork', ET_DOMAIN);?>">
                      </div>
                  </div>
                  <div class="col-md-8">
                      <div class="fre-input-field dropdown">
                          <label for="skills" class="fre-field-title"><?php _e('Skill', ET_DOMAIN);?></label>
                          <input id="skills" class="dropdown-toggle fre-skill-field" type="text" placeholder="Search freelancers by skill" data-toggle="dropdown" readonly>
                  ...
                  <div class="col-md-4">
                      <div class="fre-input-field">
                          ...
                          <?php ae_tax_dropdown( 'project_category' , array(  
                                    ...
                                    'show_option_all' => __("Select categories", ET_DOMAIN),
              ...
              <a class="profile-filter-clear clear-filter" href=""><?php _e('Clear all filter', ET_DOMAIN);?></a>
          </form>
      </div>
  </div>
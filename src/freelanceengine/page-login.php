				...
				<div class="fre-authen-login">
					...
					<form role="form" id="signin_form" class="">
						...
						<div class="fre-input-field">
							<input type="text" name="user_login" placeholder="<?php _e('Username or Email', ET_DOMAIN)?>">
						</div>
						<div class="fre-input-field">
					...
					<div class="fre-authen-footer">
						...
						<div class="not-yet-register">
							<a href="<?php echo et_get_page_link("register") ?>" class=""><?php _e('Not yet register?', ET_DOMAIN)?></a>
						</div>
						<?php } ?>
						<div class="forgot-password">
							<a href="<?php echo et_get_page_link("forgot-password") ?>" class=""><?php _e('Forgot password?', ET_DOMAIN)?></a>
						</div>
					</div>
				</div>
			</div>

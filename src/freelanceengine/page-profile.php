                                                    ...
                                                    <form class="form-detail-profile-page" id="profile_form">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="fre-input-field hourly-rate">
                                                                <label class="fre-field-title"><?php _e('Price per 1000 words', ET_DOMAIN) ?></label>
                                                                <div class="row">
                                                                    <div class="col-xs-8">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="fre-input-field profile-category">
                                                                <label class="fre-field-title"><?php _e('Source language', ET_DOMAIN) ?></label>
                                                                <?php
                                                                $cate_arr = array();
                                                        ...
                                                        <div class="form-group">
                                                            <div class="fre-input-field">
                                                                <label class="fre-field-title"><?php _e('Target language', ET_DOMAIN) ?></label>
                                                                <?php
                                                                    $country_arr = array();
